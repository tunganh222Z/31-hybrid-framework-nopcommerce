...
public class MyAccountSideBarPageUI {
    public static final String ADDRESS_LINK_TEXT = "xpath=//a[contains(text(),'Addresses')]/ancestor::div[@class='block block-account-navigation']";
    ...
    public static final String DYNAMIC_SIDEBAR_LINK_TEXT = "xpath=//div[@class='block block-account-navigation']//a[contains(text(),'%s')]";
